...
ltl prop1 { [] (((current[2] == failure) && <> (current[3] == at_obstacle)) -> <> ((current[4] == after_change) && [] (current[3] != at_obstacle))) }

ltl prop2 { <> [] ((last_label != move) && (last_label != at_obstacle_l) && (last_label != follow)) -> [] (current[3] == not_at_target -> <> (last_label == take_photo)) }